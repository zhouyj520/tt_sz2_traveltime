...
ax2 = subplot(1,3,2);
cb2 = plot_cubefaces(ax2, V1, x_km, y_km, z_km, FACE_POS, [vmin vmax], 'Decompressed (REL=1e-5)', 'parula');

ax3 = subplot(1,3,3);
cb3 = plot_cubefaces(ax3, VE, x_km, y_km, z_km, FACE_POS, [0 ecax], 'Absolute Error (REL=1e-5)', 'hot');
